 ...
 * Custom renderer.
 */
public class XYLineAndAreaRenderer extends XYAreaRenderer {
     ...
     */
    public XYLineAndAreaRenderer(int type) {
        this(type, null, null);
    }
     ...
     */
    public XYLineAndAreaRenderer(int type, XYToolTipGenerator toolTipGenerator,
